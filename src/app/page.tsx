            ...
            <AnimatePresence mode="wait">
              {!selectedRecipe ? (
                ...
                <motion.div
                  key="details-view"
                  ref={detailsRef}
                  initial={{ opacity: 0, x: isCookingMode ? 0 : '100%' }}
                ...
                >
                  <Button onClick={handleBack} variant="ghost" className="mb-4">
                    ...
                    {mode === 'ingredients' ? 'Results' : 'Search'}
                  </Button>
                  <AnimatePresence mode="wait">
                    {isCookingMode && recipeDetails.data ? (
                      <motion.div
                        key="cooking-mode"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        ...
                        <Card className="shadow-lg">
                          ...
                          <CardFooter className="flex justify-between">
                            ...
                            {currentStep < recipeDetails.data.instructions.length - 1 ? (
                              ...
                              <Button onClick={() => setIsCookingMode(false)} className="bg-green-600 hover:bg-green-700">
                                I'm done!
                              </Button>
                            )}
                          </CardFooter>
